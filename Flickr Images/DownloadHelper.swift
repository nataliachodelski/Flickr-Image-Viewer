...
public class DownloadHelper {
    ...
    private let myAPIKey: String = "bd572be0a9130ed85862e0ca053e99df"
    private let myAPISecret: String = "69a2a7029940acc1"
    private let flickrUserID: String = "34427469121@N01"
    private let maxImages: Int = 150
